...
{
    internal class EntityEquipment
    {
        ...
        public EntityEquipment(INETWISEDriverSink sink, DatabaseHandle databaseHandle, ObjectHandle objectHandle)
        {
            this.WISESink = sink;
        ...
        public WISE_RESULT CreateInstance(INETWISEDriverSink sink, DatabaseHandle hDatabase, string objectName)
        {
            ...
            if (objectHandle == WISEConstants.WISE_INVALID_HANDLE)
            {
                ...
                wResult = sink.CreateObjectFromTemplate(hDatabase, objectName, EntityEquipment.ClassName, ref objectHandle, ref attributes);
            }
