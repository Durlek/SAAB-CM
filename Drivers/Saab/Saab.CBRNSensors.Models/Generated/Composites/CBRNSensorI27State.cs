...
{
    public class CBRNSensorI27State
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorI27State(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorI27State(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".TemperatureError", Fields.TemperatureError);
                    }
        ...
        public byte TemperatureErrorValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.TemperatureError, this.ParentAttribute);
