...
{
    public class CBRNSensorAP2CeData
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorAP2CeData(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorAP2CeData(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public string SubstanceCategoryValue
        {
            get
            {
