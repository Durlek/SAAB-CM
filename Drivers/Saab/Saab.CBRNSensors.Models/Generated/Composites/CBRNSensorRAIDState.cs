...
{
    public class CBRNSensorRAIDState
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorRAIDState(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorRAIDState(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".SubstanceLibrary", Fields.SubstanceLibrary);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".DeviceState", Fields.DeviceState);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".DeviceError", Fields.DeviceError);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".InternalState", Fields.InternalState);
                    }
        ...
        public byte SubstanceLibraryValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.SubstanceLibrary, this.ParentAttribute);
        ...
        public int DeviceStateValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.DeviceState, this.ParentAttribute);
        ...
        public int DeviceErrorValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.DeviceError, this.ParentAttribute);
        ...
        public byte InternalStateValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.InternalState, this.ParentAttribute);
