...
{
    public class CBRNSensorRapidState
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorRapidState(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorRapidState(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".CalibrationStatus", Fields.CalibrationStatus);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".SubstanceLibrary", Fields.SubstanceLibrary);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".SamplingMode", Fields.SamplingMode);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".Status", Fields.Status);
                    }
        ...
        public byte CalibrationStatusValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.CalibrationStatus, this.ParentAttribute);
        ...
        public byte SamplingModeValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.SamplingMode, this.ParentAttribute);
        ...
        public byte StatusValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.Status, this.ParentAttribute);
