...
{
    public class CBRNSensorRAIDData
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorRAIDData(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorRAIDData(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".ConcentrationUnit", Fields.ConcentrationUnit);
        ...
        public byte ConcentrationUnitValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.ConcentrationUnit, this.ParentAttribute);
