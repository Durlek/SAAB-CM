...
{
    public class CBRNSensorI28Data
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorI28Data(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorI28Data(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".CurrentDoseRate", Fields.CurrentDoseRate);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".PeakDoseRate", Fields.PeakDoseRate);
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".AccumulatedDoseRate", Fields.AccumulatedDoseRate);
                    }
        ...
        public int CurrentDoseRateValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.CurrentDoseRate, this.ParentAttribute);
        ...
        public int PeakDoseRateValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.PeakDoseRate, this.ParentAttribute);
        ...
        public int AccumulatedDoseRateValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.AccumulatedDoseRate, this.ParentAttribute);
