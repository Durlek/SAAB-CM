...
{
    public class CBRNSensorI28State
    {
        #region Types
        public enum Fields
        {
        ...
        #region Constructors
        public CBRNSensorI28State(string parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
        ...
        public CBRNSensorI28State(AttributeHandle parentAttribute, INETWISEStringCache cache, AttributeGroup data)
        {
            ...
            if (!IsInitialized(hAttribute))
            {
                ...
                lock (_nameIdIndex)
                {
                    if (!_nameIdIndex.ContainsKey(hAttribute))
                    {
                        ...
                        _nameIdIndex[hAttribute].Add(strAttributeName + ".Errorcode", Fields.Errorcode);
                    }
        ...
        public int ErrorcodeValue
        {
            get
            {
                AttributeHandle hAttribute = GetFieldHandle(Fields.Errorcode, this.ParentAttribute);
