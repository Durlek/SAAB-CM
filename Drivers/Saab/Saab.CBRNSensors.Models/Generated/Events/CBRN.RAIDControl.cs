...
{
    public partial class CBRNRAIDControl
    {
        #region Type definitions

        /// <summary>
        /// Enumeration of attributes in CBRNRAIDControl events.
        /// </summary>
        ...
        protected static BiDirectionalIndex<string, CBRNRAIDControl.Attributes> _nameIdIndex = new BiDirectionalIndex<string, Attributes>();
        protected static BiDirectionalIndex<CBRNRAIDControl.Attributes, AttributeHandle> _idHandleIndex = new BiDirectionalIndex<Attributes, AttributeHandle>();
        ...
        public CBRNRAIDControl(INETWISEDriverSink2 WISE, DatabaseHandle databaseHandle, EventHandle eventHandle)
        {
            this.WISE = WISE;
        ...
        {
            return (className == CBRNRAIDControl.ClassName);
        }

        static public bool IsTypeOf(ClassHandle hClass)
        {
            return (hClass == CBRNRAIDControl.Class);
        }
        ...
        public uint CreateInstance(INETWISEDriverSink2 WISE, DatabaseHandle hDatabase)
        {
            ...
            if (eventHandle == WISEConstants.WISE_INVALID_HANDLE)
            {
                ...
                result = WISE.CreateEventFromTemplate(hDatabase, CBRNRAIDControl.ClassName, ref eventHandle, ref attributes);
            }
