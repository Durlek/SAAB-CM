...
namespace Saab.CBRNSensors.Models
{
    ...
    public class BiDirectionalIndex<TFirst, TSecond>
    {
        #region Members

        private IDictionary<TFirst, TSecond> firstToSecond = null;
        private IDictionary<TSecond, TFirst> secondToFirst = null;

        #endregion

        #region Constructors

        public BiDirectionalIndex()
        {
            firstToSecond = new Dictionary<TFirst, TSecond>();
            secondToFirst = new Dictionary<TSecond, TFirst>();
        }

        public BiDirectionalIndex(IEqualityComparer<TFirst> comparer)
        {
            firstToSecond = new Dictionary<TFirst, TSecond>(comparer);
            secondToFirst = new Dictionary<TSecond, TFirst>();
        }

        public BiDirectionalIndex(IEqualityComparer<TSecond> comparer)
        {
            firstToSecond = new Dictionary<TFirst, TSecond>();
            secondToFirst = new Dictionary<TSecond, TFirst>(comparer);
        }
        ...
        public bool ExistFirst(TFirst first)
        {
            return firstToSecond.ContainsKey(first);
        }

        public bool ExistSecond(TSecond second)
        {
            return secondToFirst.ContainsKey(second);
        }

        public IEnumerable<KeyValuePair<TFirst, TSecond>> FirstToSecond
        {
            get { return firstToSecond; }
        }

        public IEnumerable<KeyValuePair<TSecond, TFirst>> SecondToFirst
        {
