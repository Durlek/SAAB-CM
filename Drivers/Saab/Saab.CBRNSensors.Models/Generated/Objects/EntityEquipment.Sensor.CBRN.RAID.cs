...
{
    public partial class EntityEquipmentSensorCBRNRAID : WISEObject
    {
        #region Type definitions

        /// <summary>
        /// Enumeration of attributes in EntityEquipmentSensorCBRNRAID objects.
        /// </summary>
        ...
        protected static BiDirectionalIndex<string, EntityEquipmentSensorCBRNRAID.Attributes> _nameIdIndex = new BiDirectionalIndex<string, Attributes>();
        protected static BiDirectionalIndex<EntityEquipmentSensorCBRNRAID.Attributes, AttributeHandle> _idHandleIndex = new BiDirectionalIndex<Attributes, AttributeHandle>();
        ...
        {
            get { return "EntityEquipment.Sensor.CBRN.RAID"; }
        }
        ...
        {
            get { return CBRNSensorsEntityTypes.EntityEquipmentSensorCBRNRAID; }
        }
        ...
        public EntityEquipmentSensorCBRNRAID() : base() {}

        public EntityEquipmentSensorCBRNRAID(INETWISEDriverSink2 WISE, DatabaseHandle databaseHandle, ObjectHandle objectHandle)
            : base(WISE, databaseHandle, objectHandle) {}

        public EntityEquipmentSensorCBRNRAID(INETWISEDriverSink2 WISE, DatabaseHandle databaseHandle, ObjectHandle objectHandle, TransactionHandle transactionHandle)
        ...
        {
            return (className == EntityEquipmentSensorCBRNRAID.ClassName);
        }

        static public bool IsTypeOf(ClassHandle hClass)
        {
            return (hClass == EntityEquipmentSensorCBRNRAID.Class);
        }
        ...
        public override uint CreateInstance(INETWISEDriverSink2 WISE, DatabaseHandle hDatabase, string objectName)
        {
            ...
            if (objectHandle == WISEConstants.WISE_INVALID_HANDLE)
            {
                ...
                result = WISE.CreateObjectFromTemplate(hDatabase, objectName, EntityEquipmentSensorCBRNRAID.ClassName, ref objectHandle, ref attributes);
            }
...
// OBJECTIMPL: AttributeGroup
        public CBRNSensorRAIDState SensorState   
        {
            get
            {
                ...
                return new CBRNSensorRAIDState(attributeHandle, this.StringCache, value);
            }
            ...
            set
            {
                ...
                else if (value.ParentAttribute != attributeHandle)
                {
                    ...
                    CBRNSensorRAIDState.ChangeParent(value.ParentAttribute, value.Data, attributeHandle, newValue);
                }
