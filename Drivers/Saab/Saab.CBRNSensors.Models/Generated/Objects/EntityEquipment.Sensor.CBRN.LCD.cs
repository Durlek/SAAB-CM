...
namespace Saab.CBRNSensors.Models
{
    public partial class EntityEquipmentSensorCBRNLCD : WISEObject
    {
        ...
        {
            get { return CBRNSensorsEntityTypes.EntityEquipmentSensorCBRNLCD; }
        }
        ...
        public EntityEquipmentSensorCBRNLCD() : base() {}

        public EntityEquipmentSensorCBRNLCD(INETWISEDriverSink2 WISE, DatabaseHandle databaseHandle, ObjectHandle objectHandle)
        ...
        {
            return (hClass == EntityEquipmentSensorCBRNLCD.Class);
        }
        ...
        public override uint CreateInstance(INETWISEDriverSink2 WISE, DatabaseHandle hDatabase, string objectName)
        {
            ...
            if (objectHandle == WISEConstants.WISE_INVALID_HANDLE)
            {
                ...
                result = WISE.CreateObjectFromTemplate(hDatabase, objectName, EntityEquipmentSensorCBRNLCD.ClassName, ref objectHandle, ref attributes);
            }
